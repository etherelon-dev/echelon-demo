...
export default function MapCompassHud({ transform, containerSize }: MapCompassHudProps) {
  return (
    <div className="absolute bottom-4 left-4 z-10 flex items-end gap-3 sm:bottom-6 sm:left-6">
      <div className="relative flex h-14 w-14 items-center justify-center rounded-full border border-bone/10 bg-ink-900/70 backdrop-blur-sm">
      ...
      <div className="rounded-sm border border-bone/10 bg-ink-900/70 px-2.5 py-1.5 backdrop-blur-sm">
